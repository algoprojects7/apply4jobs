  ...
  return (
    ...
    >
      <div style={{ maxWidth: '520px', margin: '0 auto', padding: '32px 0' }}>
        {/* Header Card */}
        <div style={{
          background: 'linear-gradient(135deg, rgba(109,40,217,0.15), rgba(167,139,250,0.08))',
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              style={{
                width: '100%',
                padding: '14px',
                background: loading ? 'rgba(109,40,217,0.4)' : 'linear-gradient(135deg, #6d28d9, #7c3aed)',
                border: 'none',
                borderRadius: '10px',
                color: '#ffffff',
                fontSize: '15px',
        ...
        <div style={{
          ...
          {[
            ...
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '6px' }}>
              <div style={{ width: '5px', height: '5px', borderRadius: '50%', background: '#6d28d9', flexShrink: 0 }} />
