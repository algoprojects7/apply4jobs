          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
            <thead>
              <tr style={{ borderBottom: '1px solid #d0d7de' }}>
                <th style={{ paddingBottom: '12px', color: '#57606a', fontWeight: 600, fontSize: '13.5px' }}>Company</th>
                <th style={{ paddingBottom: '12px', color: '#57606a', fontWeight: 600, fontSize: '13.5px' }}>Domain</th>
                <th style={{ paddingBottom: '12px', color: '#57606a', fontWeight: 600, fontSize: '13.5px' }}>Listings Count</th>
                <th style={{ paddingBottom: '12px', color: '#57606a', fontWeight: 600, fontSize: '13.5px' }}>Status</th>
                <th style={{ paddingBottom: '12px', color: '#57606a', fontWeight: 600, fontSize: '13.5px', textAlign: 'right' }}>Actions</th>
              </tr>
            </thead>
            <tbody>
              {tenants.map(t => (
                <tr key={t.id} style={{ borderBottom: '1px solid #eaeef2' }}>
                  <td style={{ padding: '14px 0', fontSize: '14px', fontWeight: 600 }}>{t.name}</td>
                  <td style={{ padding: '14px 0', fontSize: '14px', color: '#57606a' }}>{t.domain}</td>
                  <td style={{ padding: '14px 0', fontSize: '14px' }}>{t.jobs}</td>
                  <td style={{ padding: '14px 0', fontSize: '14px' }}>
                    <span style={{
                  ...
                  <td style={{ padding: '14px 0', fontSize: '14px', textAlign: 'right' }}>
